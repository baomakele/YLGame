...
Shader "Ciconia Studio/Effects/Water And Caustic/Water/Fast" {
    Properties {
...
////// Specular:
                ...
                float3 BaseColor = lerp(_Color.rgb,saturate((1.0-(1.0-(_TideColor.rgb*(1.0 - saturate((sceneZ-partZ)/_TideDepth))*lerp(0,10,_TideSharpen)))*(1.0-_ShoreColor.rgb))),(1.0 - saturate(saturate((sceneZ-partZ)/_ShoreDepth))));
