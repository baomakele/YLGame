...
Shader "Ciconia Studio/Effects/Water And Caustic/Caustic/Advanced" {
    Properties {
        ...
        [Space(20)][MaterialToggle] _AffectedbySun ("Affected by Sun", Float ) = 0
        _LightDepth ("Light Depth", Range(-2, 2)) = 0.2343708
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
///////// Gloss:
                ...
                float Spec1A = _SpecGlossMap_var.a;
                float Glossiness = (Spec1A*_Glossiness);
...
////// Specular:
                ...
                float node_2148 = Ao;
                float3 specularAO = lerp( 1.0, node_2148, _SpecularOcclusion );
                ...
                float3 indirectSpecular = (gi.indirect.specular + CubemapSpec) * specularAO;
...
/////// Diffuse:
                ...
                indirectDiffuse *= node_2148; // Diffuse AO
...
////// Emissive:
                ...
                float3 node_1228 = (_CausticColor.rgb*saturate((_Caustic1.rgb*_Caustic2.rgb))*_Intensity);
                float4 _ExclusionMask_var = tex2D(_ExclusionMask,TRANSFORM_TEX(i.uv0, _ExclusionMask));
                float3 Caustic = (lerp( node_1228, (node_1228*saturate((dot(i.normalDir,lightDirection)+_LightDepth))), _AffectedbySun )*_ExclusionMask_var.r);
