...
Shader "Ciconia Studio/Effects/Water And Caustic/Water/River" {
    Properties {
        ...
        [Space(10)]_CubemapColor ("Color", Color) = (0,0,0,1)
        ...
        [Space(10)]_NormalIntensity ("Normal Intensity1", Range(0, 2)) = 0.2
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float3 _node_1398 = UnpackNormal(tex2D(_Normalwave,TRANSFORM_TEX(node_866, _Normalwave)));
                ...
                float3 _node_3492 = UnpackNormal(tex2D(_Normalwave,TRANSFORM_TEX(node_2857, _Normalwave)));
...
////// Specular:
                ...
                float3 node_3068 = lerp(_Color.rgb,saturate((1.0-(1.0-(_TideColor.rgb*(1.0 - saturate((sceneZ-partZ)/_TideDepth))*lerp(0,10,_TideSharpen)))*(1.0-_ShoreColor.rgb))),(1.0 - saturate(saturate((sceneZ-partZ)/_ShoreColorDepth))));
