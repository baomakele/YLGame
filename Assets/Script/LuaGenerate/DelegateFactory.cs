...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(CallBackNetMsgLua), CallBackNetMsgLua);
	...
	class CallBackNetMsgLua_Event : LuaDelegate
	{
		public CallBackNetMsgLua_Event(LuaFunction func) : base(func) { }
		public CallBackNetMsgLua_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(short param0, byte[] param1)
		{
			func.BeginPCall();
			func.Push(param0);
			func.Push(param1);
		...
		public void CallWithSelf(short param0, byte[] param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public static Delegate CallBackNetMsgLua(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			CallBackNetMsgLua fn = delegate(short param0, byte[] param1) { };
			return fn;
		}

		if(!flag)
		{
			CallBackNetMsgLua_Event target = new CallBackNetMsgLua_Event(func);
			CallBackNetMsgLua d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			CallBackNetMsgLua_Event target = new CallBackNetMsgLua_Event(func, self);
			CallBackNetMsgLua d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
