...
public class UIBaseWrap
{
	...
	{
		L.BeginClass(typeof(UIBase), typeof(UnityEngine.Behaviour));
	...
	static int SetImageSprite(IntPtr L)
	{
		try
		{
			...
			if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UIBase), typeof(string), typeof(string), typeof(bool)))
			{
				UIBase obj = (UIBase)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				string arg1 = ToLua.ToString(L, 3);
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UIBase), typeof(UnityEngine.UI.Image), typeof(string), typeof(bool)))
			{
				UIBase obj = (UIBase)ToLua.ToObject(L, 1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UIBase.SetImageSprite");
			}
		}
		catch(Exception e)
		{
	...
	static int SetGuideMode(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UIBase), typeof(string), typeof(int)))
			{
				UIBase obj = (UIBase)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UIBase), typeof(UnityEngine.GameObject), typeof(int)))
			{
				UIBase obj = (UIBase)ToLua.ToObject(L, 1);
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.ToObject(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
