...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		NetWorkMessageWrap.Register(L);
		GameObjectManagerWrap.Register(L);
		AutoReconnectControllerWrap.Register(L);
		...
		L.RegFunction("CallBackNetMsgLua", CallBackNetMsgLua);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int CallBackNetMsgLua(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(CallBackNetMsgLua), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(CallBackNetMsgLua), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
